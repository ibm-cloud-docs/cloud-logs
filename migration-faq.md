...
* Terraform files to create an equivalent {{site.data.keyword.logs_full_notm}} instance and configuration and to create {{site.data.keyword.logs_full_notm}} COS buckets.
...
## Can the migration configuration be verified before being applies?
{: #mig_faq_7}
{: faq}
...
* Queries for views and alerts are migrated. However, since mapping is applied in a generic fashion across all environments, you might need to modify the mapping provided by the migration tool to meet your requirements.

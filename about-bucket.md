...
You must configure and manage two {{site.data.keyword.cos_full_notm}} buckets for your {{site.data.keyword.logs_full_notm}} instance:
...
- You can configure the same bucket as your data bucket and your metrics bucket.

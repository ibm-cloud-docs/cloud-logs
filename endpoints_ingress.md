...
| Asia Pacific  | Mumbai (`in-mum`) | `<service-instance-guid>.ingress.in-mum.logs.cloud.ibm.com` |
...
| Asia Pacific  | Mumbai (`in-mum`) | `<service-instance-guid>.ingress.private.in-mum.logs.cloud.ibm.com` |

...
| `logs.data-usage.export`	| export the data usage  |
...
| `logs.extensions.get` |	Getting extension by ID |
...
| Event                                            | Description                |
|---------------------------------------------------|----------------------------|
| `logs.archive-setup.get` |	Getting archive setup  |
...
| `logs.logs.parsing-rule.order` |	order/sequencing the rule groups |
...
| `logs.logs-stream-setup.create` | Creating logs stream |
| `logs.logs-stream-setup.update` | Updating logs stream |
| `logs.logs-stream-setup.delete` | Deleting logs stream |
| `logs.logs-stream-setup.test` | Testing logs stream |

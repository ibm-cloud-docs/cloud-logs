...
Documentation on using regex for queries
:   Additional information is available on using regex for queries. For more information, see [Using regex when querying data](/docs/cloud-logs?topic=cloud-logs-query-regex).
